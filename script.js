...
let taskContainers = document.querySelectorAll('.task');
...
function assignTask(task) {
    ...
    taskContainers.forEach((taskContainer, index) => {
        var _a;
        const taskSpan = taskContainer.querySelector('span');
        // Assign task to available container if not already assigned
        if (((_a = taskSpan.textContent) === null || _a === void 0 ? void 0 : _a.startsWith("This is the task")) && !taskAssigned) {
